...
export default function FloatingContactButton() {
  ...
  return (
    <div className="fixed bottom-6 md:bottom-8 right-4 md:right-8 z-50 pointer-events-none">
      <motion.button
        onClick={handleClick}
        className="px-4 py-2 md:px-5 md:py-2.5 rounded-full font-medium text-xs md:text-sm text-background bg-linear-to-r from-primary to-accent transition-all group overflow-visible pointer-events-auto"
