      ...
      <Container size="md">
        <div className="py-12 prose prose-invert max-w-none">
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-bone mb-4">1. Agreement to Terms</h2>
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-bone mb-4">2. Description of Services</h2>
            <p className="text-bone-dim leading-relaxed mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-bone mb-4">3. User Accounts</h2>

            <h3 className="text-lg font-medium text-bone mb-3">3.1 Account Registration</h3>
            <p className="text-bone-dim leading-relaxed mb-4">
            ...
            <h3 className="text-lg font-medium text-bone mb-3">3.2 Account Responsibility</h3>
            <p className="text-bone-dim leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-bone mb-4">4. Acceptable Use</h2>
            <p className="text-bone-dim leading-relaxed mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-bone mb-4">5. WhatsApp Business Services</h2>
            <p className="text-bone-dim leading-relaxed mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-bone mb-4">6. Intellectual Property</h2>

            <h3 className="text-lg font-medium text-bone mb-3">6.1 Our Intellectual Property</h3>
            <p className="text-bone-dim leading-relaxed mb-4">
            ...
            <h3 className="text-lg font-medium text-bone mb-3">6.2 Limited License</h3>
            <p className="text-bone-dim leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-bone mb-4">7. User Content</h2>
            <p className="text-bone-dim leading-relaxed mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-bone mb-4">8. Payment Terms</h2>
            <p className="text-bone-dim leading-relaxed mb-4">
              For paid services:
            </p>
            <ul className="list-disc pl-6 text-bone-dim space-y-2">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-bone mb-4">9. Disclaimer of Warranties</h2>
            <p className="text-bone-dim leading-relaxed mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-bone mb-4">10. Limitation of Liability</h2>
            <p className="text-bone-dim leading-relaxed mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-bone mb-4">11. Indemnification</h2>
            <p className="text-bone-dim leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-bone mb-4">12. Termination</h2>
            <p className="text-bone-dim leading-relaxed mb-4">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-bone mb-4">13. Modifications to Terms</h2>
            <p className="text-bone-dim leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-bone mb-4">14. Governing Law</h2>
            <p className="text-bone-dim leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-bone mb-4">15. Dispute Resolution</h2>
            <p className="text-bone-dim leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-bone mb-4">16. Severability</h2>
            <p className="text-bone-dim leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-bone mb-4">17. Entire Agreement</h2>
            <p className="text-bone-dim leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold text-bone mb-4">18. Contact Information</h2>
            <p className="text-bone-dim leading-relaxed mb-4">
